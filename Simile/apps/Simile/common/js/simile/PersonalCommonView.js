...
define([
	...
	return declare([ScrollableView], {
		...
		startup: function() {
			...
			this.personalCommon = dom.byId("personalCommon");
			this.personalCommonHeading = registry.byId("personalCommonHeading");
		...
		refresh: function() {
			...
			this.personalCommon.appendChild(this.progressIndicator.domNode);
			...
			// restore the title
			this.personalCommonHeading.set('label','Common Traits');			
			
			//var personalCompatibilty = this.totalCompatibility.commonInterests;
		},
		// error handler
		onError: function(error) {
			...
			this.personalCommonHeading.set('label',error);
			alert(error);
		},
		//  response handler
